...
export function normalizeImportTextCase(value, opts = {}) {
    ...
    // Nombre / partes de identidad: siempre título por palabra
    const nameKeys = new Set(['name', 'nombres', 'apellidopaterno', 'apellidomaterno']);
    if (nameKeys.has(normalizeFieldKey(field))) {
