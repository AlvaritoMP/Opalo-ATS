...
import { BulkDocumentTemplatesEditor } from './BulkDocumentTemplatesEditor';

interface BulkDocumentTemplatesModalProps {
    isOpen: boolean;
    onClose: () => void;
    processTitle?: string;
    templates: BulkDocumentTemplate[];
    customColumns: CustomColumn[];
    onSave: (templates: BulkDocumentTemplate[]) => Promise<void>;
}

export const BulkDocumentTemplatesModal: React.FC<BulkDocumentTemplatesModalProps> = ({
    isOpen,
    onClose,
    processTitle,
    templates,
    ...
    const [draft, setDraft] = useState<BulkDocumentTemplate[]>(templates);
