...
-- ============================================
-- Tablas de integración entre Opalo ATS y OpsFlow.
-- Solo Opalo ATS crea envíos; OpsFlow consume y actualiza estados.
--
-- INSTRUCCIONES:
...
'Paquetes de datos enviados desde Opalo ATS hacia OpsFlow (canal entre áreas).';

COMMENT ON COLUMN worker_handoff_packages.source_app IS 'Siempre Opalo ATS para envíos desde selección.';
